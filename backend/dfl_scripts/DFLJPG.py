...
class DFLJPG(object):
    ...
    # custom export
    def get_custom_params(self):         return self.dfl_dict.get ('custom_params', None)
    def set_custom_params(self, params): self.dfl_dict['custom_params'] = params 
    ...
    def get_xseg_mask(self, dfl_type=False): 
        mask_buf = self.dfl_dict.get('xseg_mask',None)
        if mask_buf is None:
            return None
    ...
    def embed_data(filename, face_type=None,
        ...
        inst.set_custom_params(custom_params)
    ...
    def embed_and_set(self, filename, face_type=None,
        ...
        if xseg_mask is None: xseg_mask = self.get_xseg_mask(dfl_type=True)
        if custom_params is None: custom_params = self.get_custom_params()
